...
class TestParseRating:
    ...
    def test_explicit_label_cautious_buy(self):
        assert parse_rating("Rating: Cautious Buy\nDetails.") == "Cautious Buy"
    ...
    def test_no_rating_custom_default(self):
        assert parse_rating("Plain prose.", default="Reduce") == "Reduce"
...
class TestSignalProcessor:
    def test_returns_rating_from_pm_markdown(self):
        sp = SignalProcessor()
        md = "**Rating**: Cautious Buy\n\n**Executive Summary**: Build gradually."
        assert sp.process_signal(md) == "Cautious Buy"
